...
WATCHLIST = [
    ...
    {"name": "浙江龙盛", "code": "600352", "sector": "染料化工"},
    ...
    {"name": "力量钻石", "code": "301071", "sector": "钻石超硬"},
    {"name": "惠丰钻石", "code": "920725", "sector": "钻石超硬"},
    {"name": "四方达", "code": "300179", "sector": "钻石超硬"},
    {"name": "黄河旋风", "code": "600172", "sector": "钻石超硬"},
    ...
    {"name": "新芝生物", "code": "920685", "sector": "医药医疗"},
    ...
    # ---- 2026-09-14 新增：产业跟踪（build_industry.py）两个板块的完整成分股 ----
    {"name": "闰土股份", "code": "002440", "sector": "染料化工"},
    {"name": "亚邦股份", "code": "603188", "sector": "染料化工"},
    {"name": "吉华集团", "code": "603980", "sector": "染料化工"},
    {"name": "锦鸡股份", "code": "300798", "sector": "染料化工"},
    {"name": "中兵红箭", "code": "000519", "sector": "钻石超硬"},
    {"name": "国机精工", "code": "002046", "sector": "钻石超硬"},
    {"name": "沃尔德", "code": "688028", "sector": "钻石超硬"},
]
